...
!
!　　　簡単な説明：
!     まず他のプログラムから、各種類の格子のある長方形範囲内の各点の速度値が出力されている。
!     次に本プログラムを用いて、各種類の格子の各点の速度値をお互いに差を引いて、その差の平均値を求める。
!     最後、ある長方形範囲内の各点の誤差率が出力される。
!     さらに、その誤差率のデータをgnuplotに入れることで、誤差率の可視化もできる。
!        
!
! 2022/01/06  Dong Zixu  v0.1
!
!****************************************************
program main
